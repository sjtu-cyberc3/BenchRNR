//
// Created by runrunxin on 2024/3/24.
//

#ifndef SRC_FEC_CLUSTERING_H
#define SRC_FEC_CLUSTERING_H
#pragma once
...
std::vector<pcl::PointIndices> FEC(pcl::PointCloud<pcl::PointXYZI>::Ptr cloud, int min_component_size, double tolorance, int max_n) {
